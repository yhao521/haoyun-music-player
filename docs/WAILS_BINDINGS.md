...
```
frontend/bindings/
├── github.com/yhao521/haoyun-music-player/           # 模块名称（来自 go.mod）
...
运行 `wails3 dev` 后，会在 `frontend/bindings/github.com/yhao521/haoyun-music-player/` 目录下生成：
...
# 查看内容
cat frontend/bindings/github.com/yhao521/haoyun-music-player/musicservice.ts
```
