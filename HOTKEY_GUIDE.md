...
1. **系统媒体键**（F7-F9）- 需要 macOS 辅助功能权限
2. **自定义全局快捷键** - 无需特殊权限，开箱即用

## ⌨️ 默认快捷键列表

| 快捷键 | 功能 | 说明 |
|--------|------|------|
| `Space` | 播放/暂停 | 切换当前播放状态 |
| `Ctrl + →` | 下一曲 | 跳到播放列表的下一首歌曲 |
| `Ctrl + ←` | 上一曲 | 跳到播放列表的上一首歌曲 |
| `Ctrl + ↑` | 音量增加 | 每次增加 10% 音量 |
| `Ctrl + ↓` | 音量减少 | 每次减少 10% 音量 |
